...
# -----------------------------
st.set_page_config(
    page_title="Ollama ChatGPT Clone",
    layout="centered"
)
...
st.markdown("""
<div class="hero-card">
    <div class="brand-title">Harsha's AI Chatbot</div>
    <div class="brand-subtitle">Built a Generative AI app using Python, Streamlit and Ollama.</div>
